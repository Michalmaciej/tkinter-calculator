...
label_result = Label(root, width = 25, height = 2, text = "", font = ("Arial", 30), fg = "#fff", bg = "#2a2d36")
label_result.pack()

button_c = Button(root, image = photo_C_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: clear(), relief = SUNKEN)
button_c.bind("<Enter>", on_c)
button_c.bind("<Leave>", off_c)
button_c.place(x = 10, y = 100)

button_slash = Button(root, image = photo_slash_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("/"), relief = SUNKEN)
button_slash.bind("<Enter>", on_slash)
button_slash.bind("<Leave>", off_slash)
button_slash.place(x = 150, y = 100)

button_proc = Button(root, image = photo_slash_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("%"), relief = SUNKEN)
button_proc.bind("<Enter>", on_proc)
button_proc.bind("<Leave>", off_proc)
button_proc.place(x = 290, y = 100)

button_st = Button(root, image = photo_st_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("*"), relief = SUNKEN)
button_st.bind("<Enter>", on_st)
button_st.bind("<Leave>", off_st)
button_st.place(x = 430, y = 100)

button_7 = Button(root, image = photo_7_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("7"), relief = SUNKEN)
button_7.bind("<Enter>", on_7)
button_7.bind("<Leave>", off_7)
button_7.place(x = 10, y = 200)

button_8 = Button(root, image = photo_8_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("8"), relief = SUNKEN)
button_8.bind("<Enter>", on_8)
button_8.bind("<Leave>", off_8)
button_8.place(x = 150, y = 200)

button_9 = Button(root, image = photo_9_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("9"), relief = SUNKEN)
button_9.bind("<Enter>", on_9)
button_9.bind("<Leave>", off_9)
button_9.place(x = 290, y = 200)

button_minus = Button(root, image = photo_minus_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("-"), relief = SUNKEN)
button_minus.bind("<Enter>", on_minus)
button_minus.bind("<Leave>", off_minus)
button_minus.place(x = 430, y = 200)

button_4 = Button(root, image = photo_4_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("4"), relief = SUNKEN)
button_4.bind("<Enter>", on_4)
button_4.bind("<Leave>", off_4)
button_4.place(x = 10, y = 300)

button_5 = Button(root, image = photo_5_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("5"), relief = SUNKEN)
button_5.bind("<Enter>", on_5)
button_5.bind("<Leave>", off_5)
button_5.place(x = 150, y = 300)

button_6 = Button(root, image = photo_6_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("6"), relief = SUNKEN)
button_6.bind("<Enter>", on_6)
button_6.bind("<Leave>", off_6)
button_6.place(x = 290, y = 300)

button_plus = Button(root, image = photo_plus_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("+"), relief = SUNKEN)
button_plus.bind("<Enter>", on_plus)
button_plus.bind("<Leave>", off_plus)
button_plus.place(x = 430, y = 300)

button_1 = Button(root, image = photo_1_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("1"), relief = SUNKEN)
button_1.bind("<Enter>", on_1)
button_1.bind("<Leave>", off_1)
button_1.place(x = 10, y = 400)

button_2 = Button(root, image = photo_2_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("2"), relief = SUNKEN)
button_2.bind("<Enter>", on_2)
button_2.bind("<Leave>", off_2)
button_2.place(x = 150, y = 400)

button_3 = Button(root, image = photo_3_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("3"), relief = SUNKEN)
button_3.bind("<Enter>", on_3)
button_3.bind("<Leave>", off_3)
button_3.place(x = 290, y = 400)

button_dot = Button(root, image = photo_dot_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("."), relief = SUNKEN)
button_dot.bind("<Enter>", on_dot)
button_dot.bind("<Leave>", off_dot)
button_dot.place(x = 430, y = 400)

button_0 = Button(root, image = photo_0_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("0"), relief = SUNKEN)
button_0.bind("<Enter>", on_0)
button_0.bind("<Leave>", off_0)
button_0.place(x = 10, y = 500)

button_open = Button(root, image = photo_open_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show("("), relief = SUNKEN)
button_open.bind("<Enter>", on_open)
button_open.bind("<Leave>", off_open)
button_open.place(x = 150, y = 500)

button_close = Button(root, image = photo_close_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: show(")"), relief = SUNKEN)
button_close.bind("<Enter>", on_close)
button_close.bind("<Leave>", off_close)
button_close.place(x = 290, y = 500)

button_eq = Button(root, image = photo_eq_off, border = 0, cursor = 'hand2', bg = "#2a2d36", command = lambda: calculate(), relief = SUNKEN)
button_eq.bind("<Enter>", on_eq)
button_eq.bind("<Leave>", off_eq)
button_eq.place(x = 430, y = 500)
